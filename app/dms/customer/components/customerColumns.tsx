...
// const getCustomerColumns = (onRowClick: (row: any) => void) => [
//   {
//     id: "customerName",
//     label: "Customer Name/Code",
//     render: (row: any) => (
...
//     label: "Customer Type",
//     render: (row: any) => (
//       <span className="text-gray-700">{row.customerType}</span>
//     ),
//   },
//   {
//     id: "cityType",
...
//         </span>
//       ) : (
//         <span className="text-gray-700">{row.cityType || "Nil"}</span>
//       ),
//   },
//   {
//     id: "zone",
//     label: "Zone",
//     render: (row: any) => (
//       <span className="text-gray-700">{row.zone || "Nil"}</span>
//     ),
//   },
//   {
//     id: "distributorName",
