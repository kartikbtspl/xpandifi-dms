...
const getChallanItemListColumn = (): Column[] => [
  {
    id: 'srNo',
    label: 'Sr. No',
    render: (row) => (
  ...
  },
  {
    ...
    label: 'Qty',
    render: (row) => (
      <span className="text-gray-700 cursor-pointer bg-[#D9E6FF] p-2 rounded-md">{row.qty}</span>
    ),
  },
  {
    id: 'msp',
...
export default getChallanItemListColumn;
